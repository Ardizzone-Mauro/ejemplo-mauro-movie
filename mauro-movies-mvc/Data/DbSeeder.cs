...
{
    // Asegúrate de que solo exista un método Seed con la firma Seed(MovieDbContext context)
    // Si tienes dos métodos con la misma firma, elimina o renombra uno.
    // Ejemplo de corrección: renombrar uno de los métodos
